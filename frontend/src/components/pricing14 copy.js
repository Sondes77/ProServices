              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <p className="thq-body-large">
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text199">$299.99/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                      ...
                      {props.plan1Feature1 ?? (
                        <Fragment>
                          <span className="pricing14-text200">
                            Profile listing on the platform
                          </span>
                        </Fragment>
                      )}
                    </span>
                      ...
                      {props.plan1Feature2 ?? (
                        <Fragment>
                          <span className="pricing14-text161">
                            Contact details visible to users
                          </span>
                        </Fragment>
                      )}
                    </span>
              ...
              <div className="pricing14-price16">
                <div className="pricing14-price17">
                  ...
                  <h3 className="pricing14-text132 thq-heading-3">
                    {props.plan1Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text173">$29.99/month</span>
                      </Fragment>
                    )}
                  </h3>
