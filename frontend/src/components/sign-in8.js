      ...
      <div className="sign-in8-max-width thq-section-max-width">
        <div className="sign-in8-container2">
          <img
            alt={props.image1Alt}
            src={props.image1Src}
            className="sign-in8-sign-up-image thq-img-ratio-4-6"
          />
          <div className="sign-in8-container3">
            <div className="sign-in8-container4 thq-section-padding">
              <img
                alt={props.image2Alt}
                src={props.imageSrc}
                className="sign-in8-image"
              />
              <h2 className="sign-in8-text10 thq-heading-2">
                {props.heading2 ?? (
                  <Fragment>
                    <span className="sign-in8-text22">Start today</span>
                  </Fragment>
                )}
              </h2>
              <p className="sign-in8-text11 thq-body-large">
                {props.content1 ?? (
                  <Fragment>
                    <span className="sign-in8-text23">
        ...
        <div className="sign-in8-form-root thq-section-padding">
          <div className="sign-in8-container5">
            <p className="sign-in8-text12 thq-body-large">
              Don&apos;t have an account? Sign up
            </p>
          </div>
          <div className="sign-in8-form1">
            <h2 className="thq-heading-2 sign-in8-text13">
              {props.heading1 ?? (
                <Fragment>
                  <span className="sign-in8-text24">Sign in</span>
                </Fragment>
              )}
            </h2>
            <div className="sign-in8-container6">
            ...
            <form className="sign-in8-form2">
              ...
              <div className="sign-in8-password">
                <div className="sign-in8-textfield">
                  <div className="sign-in8-container7">
                    <label
            ...
            >
              <span className="sign-in8-text20 thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="sign-in8-text21">Sign in</span>
                  </Fragment>
                )}
              </span>
            </button>
...
SignIn8.defaultProps = {
  action1: undefined,
  image1Src:
    'https://images.unsplash.com/photo-1518976024611-28bf4b48222e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NTUzMzA5MHw&ixlib=rb-4.0.3&q=80&w=1080',
  image1Alt: 'SignUp Image',
  heading2: undefined,
  image2Alt: 'Company Logo',
  content1: undefined,
  imageSrc:
    'https://images.unsplash.com/photo-1629905679177-4c4e2623654f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NTUzMzA5MHw&ixlib=rb-4.0.3&q=80&w=1080',
  heading1: undefined,
}
