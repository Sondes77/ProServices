          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      Register as a professional by providing your name,
                      profession, city, and contact details.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28">
                      Users can search for professionals based on job type and
                      location to find the right match for their needs.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container6 thq-card">
              <h2 className="thq-heading-2">
                {props.step3Title ?? (
                  <Fragment>
                    <span className="steps2-text30">Filter Results</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      Use filter functionalities to narrow down the search
                      results and find the most suitable professional for the
                      job.
                    </span>
                  </Fragment>
                )}
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text31">
                      Easily connect with the chosen professional to discuss the
                      job requirements and schedule appointments.
                    </span>
                  </Fragment>
                )}
              </span>
