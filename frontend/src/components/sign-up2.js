          ...
          <div className="sign-up2-form1">
            <div className="sign-up2-title-root">
              <h2 className="thq-heading-2">
                {props.heading1 ?? (
                  <Fragment>
                    <span className="sign-up2-text22">Sign Up Now</span>
                  </Fragment>
                )}
              </h2>
            ...
            <form className="sign-up2-form2">
              ...
              <div className="sign-up2-password">
                ...
                <span className="sign-up2-text17 thq-body-small">
                  {props.content1 ?? (
                    <Fragment>
                      <span className="sign-up2-text21">
            ...
            <button type="submit" className="thq-button-filled sign-up2-button">
              <span className="sign-up2-text19 thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="sign-up2-text23">Create Account</span>
                  </Fragment>
                )}
              </span>
            </button>
...
SignUp2.defaultProps = {
  content1: undefined,
  image1Src:
    'https://images.unsplash.com/photo-1638214173318-97a33a303875?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NTUzMjc5NHw&ixlib=rb-4.0.3&q=80&w=1080',
  heading1: undefined,
