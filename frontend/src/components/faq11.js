                ...
                {props.content1 ?? (
                  <Fragment>
                    <span className="faq11-text26">
                      I offer custom web development solutions, responsive
        ...
        <div className="faq11-content2 thq-flex-column">
          <div className="faq11-content3">
            <h2 className="faq11-text17 thq-heading-2">
              {props.heading2 ?? (
                <Fragment>
                  <span className="faq11-text27">Still have a question?</span>
                </Fragment>
              )}
            </h2>
              ...
              {props.content2 ?? (
                <Fragment>
                  <span className="faq11-text21">
                    Yes, I offer various pricing plans to suit different project
                    requirements.
                  </span>
                </Fragment>
              )}
          ...
          <button className="thq-button-filled">
            <span className="thq-body-small">
              {props.action ?? (
                <Fragment>
                  <span className="faq11-text19">Contact</span>
                </Fragment>
              )}
            </span>
          </button>
