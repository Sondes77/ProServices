      ...
      <div className="sign-in2-max-width thq-section-max-width">
        <div className="sign-in2-form-root">
          <h2 className="sign-in2-text10 thq-heading-2">
            {props.heading1 ?? (
              <Fragment>
                <span className="sign-in2-text23">Welcome back!</span>
              </Fragment>
            )}
          </h2>
          ...
          <div className="sign-in2-form1">
            <form className="sign-in2-form2">
              ...
              <div className="sign-in2-password">
                ...
                <input
                  ...
                  className="sign-in2-textinput2 thq-input thq-body-large"
                />
              </div>
            </form>
            <div className="sign-in2-container4">
              <button
                type="submit"
                className="sign-in2-button3 thq-button-filled"
              >
                <span className="sign-in2-text17 thq-body-small">
                  {props.action1 ?? (
                    <Fragment>
                      <span className="sign-in2-text22">Email</span>
                    </Fragment>
                  )}
                </span>
              </button>
        ...
        <div className="sign-in2-container5">
          ...
          <span className="thq-body-large">
            {props.content1 ?? (
              <Fragment>
                <span className="sign-in2-text21">
                  Sign in to access your account
                </span>
              </Fragment>
            )}
          </span>
          <button type="button" className="sign-in2-button4 thq-button-outline">
            <span className="sign-in2-text20 thq-body-small">
              {props.action2 ?? (
                <Fragment>
                  <span className="sign-in2-text24">Password</span>
                </Fragment>
              )}
            </span>
          </button>
