      ...
      <header data-thq="thq-navbar" className="navbar1-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navbar1-desktop-menu">
          <nav className="navbar1-links1">
            <a
              href={props.link1Url}
              className="navbar1-link11 thq-link thq-body-small"
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar1-text16">Home</span>
                </Fragment>
              )}
            </a>
            <a
              href={props.link2Url}
              className="navbar1-link21 thq-link thq-body-small"
            >
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar1-text14">Find Professionals</span>
                </Fragment>
              )}
            </a>
            <a
              ...
              className="navbar1-link31 thq-link thq-body-small"
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar1-text17">Pricing</span>
                </Fragment>
              )}
            </a>
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              className="navbar1-link41 thq-link thq-body-small"
            >
              {props.link4 ?? (
                <Fragment>
                  <span className="navbar1-text19">Testimonials</span>
                </Fragment>
              )}
            </a>
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              className="navbar1-link51 thq-link thq-body-small"
            >
              {props.link5 ?? (
                <Fragment>
                  <span className="navbar1-text18">
          ...
          <div className="navbar1-buttons1">
            <button className="navbar1-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar1-text15">Search</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar1-action21 thq-button-outline thq-button-animated">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar1-text20">Register</span>
                  </Fragment>
                )}
              </span>
            </button>
