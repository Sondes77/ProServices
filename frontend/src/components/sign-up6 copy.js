...
const SignUp6 = (props) => {
  ...
  // Utilisation de useRef pour référencer l'élément d'entrée du téléphone
  ...
  // Création d'états pour gérer les valeurs des champs de saisie
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        if (userRes.ok) {
          ...
          console.log('Données utilisateur récupérées email:', userData.email);
