...
import logo from '../img/noBgBlack.png';
import './footer15.css'
      ...
      <div className="footer15-max-width thq-section-max-width">
                ...
                <div className="footer15-form">
                  ...
                  <button className="thq-button-outline footer15-button">
                    <span className="thq-body-small">
                      {props.action1 ?? (
                        <Fragment>
                          <span className="footer15-text2">Contact Us</span>
                        </Fragment>
                      )}
                    </span>
                  </button>
        ...
        <div className="footer15-credits1">
          <div className="footer15-row">
            <div className="footer15-credits2">
              <span className="thq-body-small">
                {props.privacyLink ?? (
                  <Fragment>
                    <span className="footer15-text4">Privacy Policy</span>
                  </Fragment>
                )}
              </span>
              <span className="thq-body-small">
                {props.termsLink ?? (
                  <Fragment>
                    <span className="footer15-text5">Terms of Service</span>
                  </Fragment>
                )}
              </span>
              <span className="thq-body-small">
                {props.cookiesLink ?? (
                  <Fragment>
                    <span className="footer15-text1">Cookies</span>
                  </Fragment>
                )}
              </span>
            </div>
          ...
          <span className="footer15-content3 thq-body-small">
            {props.copyright ?? (
              <Fragment>
                <span className="footer15-text3">
                &copy; {new Date().getFullYear()} ServicePro. Tous droits réservés.
                </span>
              </Fragment>
            )}
          </span>
