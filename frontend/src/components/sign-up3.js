          ...
          <div className="sign-up3-form1">
            <div className="sign-up3-title-root">
              <h2 className="thq-heading-2">
                {props.heading1 ?? (
                  <Fragment>
                    <span className="sign-up3-text21">
                  ...
                  {props.content2 ?? (
                    <Fragment>
                      <span className="sign-up3-text22">
                        Create your profile, set your services and pricing, and
            ...
            <form className="sign-up3-form2">
              ...
              <div className="sign-up3-password">
                ...
                <span className="sign-up3-text15 thq-body-small">
                  {props.content1 ?? (
                    <Fragment>
                      <span className="sign-up3-text20">
                        Join our platform as a professional to connect with
            ...
            <button type="submit" className="thq-button-filled sign-up3-button">
              <span className="sign-up3-text18 thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="sign-up3-text23">Get Started</span>
                  </Fragment>
                )}
              </span>
            </button>
...
SignUp3.defaultProps = {
  image1Src:
    'https://images.unsplash.com/photo-1654723011662-e9be9ab3fe84?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NTUzMjc2Mnw&ixlib=rb-4.0.3&q=80&w=1080',
  image1Alt: 'Professional Registration',
  content1: undefined,
  heading1: undefined,
  content2: undefined,
  action1: undefined,
