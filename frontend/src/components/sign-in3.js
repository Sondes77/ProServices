...
const SignIn3 = (props) => {
  return (
    <div className="sign-in3-container1 thq-section-padding">
      <div className="sign-in3-max-width thq-section-padding thq-section-max-width">
        <div className="sign-in3-form-root">
          <div className="sign-in3-form1">
            <h2 className="sign-in3-text10 thq-heading-2">
              {props.heading1 ?? (
                <Fragment>
                  <span className="sign-in3-text20">Sign In</span>
                </Fragment>
              )}
            </h2>
            ...
            <div className="sign-in3-container3">
              ...
              >
                <span className="sign-in3-text14 thq-body-small">
                  {props.action1 ?? (
                    <Fragment>
                      <span className="sign-in3-text19">Email</span>
                    </Fragment>
                  )}
                </span>
              </button>
        ...
        <div className="sign-in3-container4">
          <div className="sign-in3-divider1">
            ...
            <p className="thq-body-large">
              {props.content1 ?? (
                <Fragment>
                  <span className="sign-in3-text17">
          ...
          <button type="button" className="sign-in3-button2 thq-button-outline">
            <span className="sign-in3-text16 thq-body-small">
              {props.action2 ?? (
                <Fragment>
                  <span className="sign-in3-text18">Password</span>
                </Fragment>
              )}
            </span>
          </button>
...
SignIn3.defaultProps = {
  image1Src:
    'https://images.unsplash.com/photo-1669220831427-6fb3b2666092?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NTUzMzAyOXw&ixlib=rb-4.0.3&q=80&w=1080',
